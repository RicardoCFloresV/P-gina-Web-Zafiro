/**
 * panel-unidadesVolumen.js
 * Módulo para gestionar la recolección de datos de los formularios de unidades de volumen.
 */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const modal = document.getElementById("modalUnidadVolumen");
